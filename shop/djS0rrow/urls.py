...
urlpatterns = [
    ...
    path('cart/add/<int:pk>/', add_to_cart_view, name='cart_add'),
    path('cart/update/<int:pk>/', update_cart_view, name='cart_update'),
    path('cart/remove/<int:pk>/', remove_from_cart_view, name='cart_remove'),
    path('cart/clear/', clear_cart_view, name='cart_clear'),
    path('cart/create-order/', create_order_from_cart_view, name='create_order_from_cart'),
